...
# ===========================================================================
HOST = "vishal"   # shown as  vishal@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "AI Intern @ Tata Steel Foundation"),
    ("kv", "Role", "MERN Developer / AI Developer"),
    ("kv", "Edu", "CSE, RVSCET Jamshedpur '27"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React.js, JavaScript, Tailwind"),
    ("kv", "Backend", "Node.js, Express, SQL, MongoDB"),
    ("kv", "AI / ML", "Python, LangChain, Gemini API"),
    ("kv", "Tools", "Git, Docker, Azure"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Real-time English<->Hindi speech translator"),
    ("bul", "200+ DSA problems solved"),
    ("bul", "GSSoC 2026 open-source contributor"),
]
